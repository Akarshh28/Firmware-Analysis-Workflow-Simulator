...
const ALL_STAGES = [
  ...
  { stage: "Symbolic Execution",    tool: "angr",       icon: "🧮", order: 9 },
  { stage: "Fuzzing",               tool: "afl",        icon: "⚡", order: 10 },
...
export const PipelineSimulator: React.FC = () => {
  const { pipeline, simulatePipeline, resetPipeline } = usePipelineStore();
        ...
        <div className="card" style={{ padding: 0, overflow: "hidden", flexShrink: 0 }}>
          <div style={{ padding: "14px 18px", borderBottom: "1px solid var(--border-subtle)" }}>
            <div className="card-title" style={{ marginBottom: 0 }}>
              <Upload size={13} /> Firmware Upload
            </div>
          </div>
              ...
              <div style={{ color: "var(--text-muted)", fontSize: 12 }}>
                {selectedFile ? (
                  <div style={{ color: "var(--accent-green)" }}>
                    <CheckCircle size={18} style={{ margin: "0 auto 6px" }} />
