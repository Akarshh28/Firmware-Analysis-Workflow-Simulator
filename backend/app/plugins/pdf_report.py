...
class PdfReportPlugin(BaseToolPlugin):
    @property
    def name(self) -> str:
        return "pdf_report"
    ...
    def documentation(self) -> Dict[str, Any]:
        return {
            "purpose": "Generate comprehensive analysis report in PDF format.",
            ...
            "internal_working": "Executes 'pdf_report' on the target.",
            "commands": [
                {
                    "command": "pdf_report --help",
                    "explanation": "Display help for pdf_report"
                }
            ],
    ...
    async def execute_simulated(self, tool_input: ToolInput) -> ToolOutput:
        ...
        return ToolOutput(
            success=True,
            exit_code=0,
            logs=[{"log_type": "SYSTEM", "message": "Simulated execution of pdf_report completed."}],
            generated_files=[],
            parsed_metrics={}
        )
