...
class UploadPlugin(BaseToolPlugin):
    @property
    def name(self) -> str:
        return "upload"
    ...
    def documentation(self) -> Dict[str, Any]:
        return {
            "purpose": "Handles uploading firmware images.",
            ...
            "internal_working": "Executes 'upload' on the target.",
            "commands": [
                {
                    "command": "upload --help",
                    "explanation": "Display help for upload"
                }
            ],
    ...
    async def execute_simulated(self, tool_input: ToolInput) -> ToolOutput:
        ...
        return ToolOutput(
            success=True,
            exit_code=0,
            logs=[{"log_type": "SYSTEM", "message": "Simulated execution of upload completed."}],
            generated_files=[],
            parsed_metrics={}
        )
